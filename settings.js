...
global.ownernomer = process.env.SUDO || '254724085270' ; //add your Owner Number 
global.ownername = process.env.SUDO_NAME || 'Tryton' ; //add your owner name
global.ytname = "YT: Infinite9452" //blank
global.socialm = "GitHub: V-E-N-O-X" //blank
global.location = "Japan, 愛知県, 名古屋市" //ur location
global.botname = process.env.BOT_NAME || 'SHADOW' //add bot name
global.ownernumber = process.env.OWNER_NUM || '254724085270' ; //add your Owner Number 
global.ownername = process.env.OWNER_NAME || 'Tryton' ; //add your owner name
global.ownerNumber = ["254724085270@s.whatsapp.net"]
global.ownerweb = "https://youtube.com/@infinite9452"
global.websitex = "https://github.com/NoelBrazza"
global.wagc = "https://chat.whatsapp.com/Ly8r369gRm0K3UAqM5Sr93"
global.themeemoji = '🎐'
global.wm = "©SHADOW"
global.botscript = 'https://github.com/NoelBrazza/Kanna-MD' //script link
global.packname = process.env.PACK_NAME || 'SHADOW' ; //Add sticker packname
global.author = process.env.AUTHOR_NAME || 'Tryton' ; //add author name 
global.creator = "254724085270@s.whatsapp.net"
